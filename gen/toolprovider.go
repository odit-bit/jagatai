...
const templ = `// Code generated; DO NOT EDIT.
...
func main() {
	...
	configFile, err := os.ReadFile("jagat/agent/toolprovider/tools.yaml")
	if err != nil {
	...
	err = os.WriteFile("jagat/agent/toolprovider/init-gen.go", out.Bytes(), 0644)
	if err != nil {
